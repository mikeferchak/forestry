...
#include "BP_PickupCube_2__pf2307895703.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/VirtualRealityBP/Blueprints/BP_PickupCube_2.BP_PickupCube_2_C", OverrideNativeName="BP_PickupCube_2_C"))
class ABP_PickupCube_2_C__pf2307895703 : public AStaticMeshActor, public IPickupActorInterface_C
{
public:
	GENERATED_BODY()
	...
	ABP_PickupCube_2_C__pf2307895703(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	void bpf__ExecuteUbergraph_BP_PickupCube_2__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_PickupCube_2__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_PickupCube_2__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_PickupCube_2__pf_3(int32 bpp__EntryPoint__pf);
