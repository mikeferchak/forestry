...
class Achoppable_C__pf2403237688;
class UProceduralMeshComponent;
#include "axe__pf2403237688.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/axe.axe_C", OverrideNativeName="axe_C"))
class Aaxe_C__pf2403237688 : public AStaticMeshActor, public IPickupActorInterface_C
{
public:
	GENERATED_BODY()
	UDELEGATE(meta=(OverrideNativeName="newPickupSlice__DelegateSignature"))
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FnewPickupSlice__pf__axe_C__pf__MulticastDelegate , UProceduralMeshComponent* , bpp__procmesh__pf, FTransform , bpp__transform__pf);
	UDELEGATE(meta=(OverrideNativeName="cloneSlicable__DelegateSignature"))
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FcloneSlicable__pf__axe_C__pf__MulticastDelegate , UProceduralMeshComponent* , bpp__procmesh__pf);
	...
	FnewPickupSlice__pf__axe_C__pf__MulticastDelegate bpv__newPickupSlice__pf;
	...
	FcloneSlicable__pf__axe_C__pf__MulticastDelegate bpv__cloneSlicable__pf;
	...
	ABP_MotionController_C__pf2307895703* bpv__controller__pf;
	...
	Achoppable_C__pf2403237688* b0l__K2Node_DynamicCast_AsChoppable__pf;
	...
	Aaxe_C__pf2403237688(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_axe_0"))
	void bpf__ExecuteUbergraph_axe__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_axe_1"))
	void bpf__ExecuteUbergraph_axe__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_axe__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_axe__pf_3(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_axe_4"))
	void bpf__ExecuteUbergraph_axe__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_axe__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_axe__pf_6(int32 bpp__EntryPoint__pf);
	...
	virtual void bpf__shouldChop__pf(FVector bpp__impulse__pf, /*out*/ bool& bpp__shouldchop__pf);
