...
#include "BP_MotionController__pf2307895703.generated.h"
...
class ABP_MotionController_C__pf2307895703 : public AActor
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="axeGrabDirection"))
	UArrowComponent* bpv__axeGrabDirection__pf;
	...
	ABP_MotionController_C__pf2307895703(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_BP_MotionController_1"))
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="spawner"))
	virtual void bpf__spawner__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="freezeComponentInController"))
	virtual void bpf__freezeComponentInController__pf();
