...
#include "BP_MotionController_2__pf2307895703.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/VirtualRealityBP/Blueprints/BP_MotionController_2.BP_MotionController_2_C", OverrideNativeName="BP_MotionController_2_C"))
class ABP_MotionController_2_C__pf2307895703 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Attached Component", Category="Default", OverrideNativeName="AttachedComponent"))
	UPrimitiveComponent* bpv__AttachedComponent__pf;
	...
	ABP_MotionController_2_C__pf2307895703(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	void bpf__ExecuteUbergraph_BP_MotionController_2__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_MotionController_2__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_MotionController_2__pf_2(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_BP_MotionController_2_3"))
	void bpf__ExecuteUbergraph_BP_MotionController_2__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_MotionController_2__pf_4(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category="Grabbing", OverrideNativeName="GrabComponent"))
	virtual void bpf__GrabComponent__pf();
	UFUNCTION(BlueprintCallable, meta=(Category="Grabbing", OverrideNativeName="GetComponentNearHand"))
	virtual void bpf__GetComponentNearHand__pf(/*out*/ UPrimitiveComponent*& bpp__NearestComponent__pf);
	UFUNCTION(BlueprintCallable, meta=(Category="Grabbing", OverrideNativeName="ReleaseComponent"))
	virtual void bpf__ReleaseComponent__pf();
public:
};
