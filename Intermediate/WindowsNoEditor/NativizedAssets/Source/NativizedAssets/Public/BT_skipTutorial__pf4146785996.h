...
class AActor;
class APawn;
#include "BT_skipTutorial__pf4146785996.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/buttons/BT_skipTutorial.BT_skipTutorial_C", OverrideNativeName="BT_skipTutorial_C"))
class ABT_skipTutorial_C__pf4146785996 : public ABT_master_C__pf4146785996
{
public:
	GENERATED_BODY()
	...
	ABT_skipTutorial_C__pf4146785996(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BT_skipTutorial__pf_0(int32 bpp__EntryPoint__pf);
