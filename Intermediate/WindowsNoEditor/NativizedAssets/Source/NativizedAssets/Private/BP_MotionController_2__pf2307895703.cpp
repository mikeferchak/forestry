...
#include "BP_MotionController_2__pf2307895703.h"
...
#endif
ABP_MotionController_2_C__pf2307895703::ABP_MotionController_2_C__pf2307895703(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABP_MotionController_2_C__pf2307895703::StaticClass() == GetClass()))
	{
		ABP_MotionController_2_C__pf2307895703::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__HandMesh__pf->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	TEXT("[65DAFE3842B9B8CC0E43B4B616167EA9]"), /* Namespace */
	TEXT("6EA53AB34F9B156BFF1378B2B6EC5D76") /* Key */
	);
	...
	bpv__ArcEndPoint__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__ArcEndPoint__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ArcEndPoint__pf->OverrideMaterials.Reserve(1);
	bpv__ArcEndPoint__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	bpv__TeleportCylinder__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	...
	bpv__TeleportCylinder__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	...
	bpv__Ring__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	bpv__Ring__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Ring__pf->OverrideMaterials.Reserve(1);
	bpv__Ring__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	bpv__Arrow__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed);
	bpv__Arrow__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Arrow__pf->OverrideMaterials.Reserve(1);
	bpv__Arrow__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	bpv__RoomScaleMesh__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed);
	bpv__RoomScaleMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__RoomScaleMesh__pf->OverrideMaterials.Reserve(1);
	bpv__RoomScaleMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed));
...
void ABP_MotionController_2_C__pf2307895703::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void ABP_MotionController_2_C__pf2307895703::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<USplineMeshComponent>(InDynamicClass, USplineMeshComponent::StaticClass(), TEXT("NODE_AddSplineMeshComponent-1"));
	InDynamicClass->ComponentTemplates.Add(__Local__3);
	auto __Local__4 = NewObject<USplineMeshComponent>(InDynamicClass, USplineMeshComponent::StaticClass(), TEXT("NODE_AddSplineMeshComponent-2"));
	...
	__Local__3->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	__Local__3->OverrideMaterials = TArray<UMaterialInterface*> ();
	__Local__3->OverrideMaterials.Reserve(1);
	__Local__3->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
	...
	__Local__4->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	__Local__4->OverrideMaterials = TArray<UMaterialInterface*> ();
	__Local__4->OverrideMaterials.Reserve(1);
	__Local__4->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_MotionController_2_C__pf2307895703::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed));
...
void ABP_MotionController_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_MotionController_2__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_MotionController_2__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_MotionController_2__pf_2(int32 bpp__EntryPoint__pf)
{
	FString bpv__CallFunc_GetObjectName_ReturnValue__pf{};
	...
	do
	{
		...
		case 17:
			{
				bpv__CallFunc_GetObjectName_ReturnValue__pf = UKismetSystemLibrary::GetObjectName(bpv__AttachedActor__pf);
				bpv__CallFunc_Conv_StringToText_ReturnValue__pf = UKismetTextLibrary::Conv_StringToText(bpv__CallFunc_GetObjectName_ReturnValue__pf);
				if(IsValid(bpv__TextRender__pf))
				{
					bpv__TextRender__pf->UTextRenderComponent::K2_SetText(bpv__CallFunc_Conv_StringToText_ReturnValue__pf);
				}
				CurrentState = 4;
				break;
			}
		case 18:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess2__pf = (b0l__K2Node_DynamicCast_AsAnim_BP_Left_Hand__pf != nullptr);;
...
void ABP_MotionController_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_MotionController_2__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__BndEvt__ControllerMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, /*out*/ FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_MotionController_2__pf_1(3);
}
void ABP_MotionController_2_C__pf2307895703::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_MotionController_2__pf_0(20);
}
void ABP_MotionController_2_C__pf2307895703::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_MotionController_2__pf_2(33);
}
void ABP_MotionController_2_C__pf2307895703::bpf__BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, /*out*/ FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BP_MotionController_2__pf_4(45);
}
void ABP_MotionController_2_C__pf2307895703::bpf__RumbleController__pf(float bpp__Intensity__pf)
{
	b0l__K2Node_CustomEvent_Intensity__pf = bpp__Intensity__pf;
	bpf__ExecuteUbergraph_BP_MotionController_2__pf_3(46);
}
void ABP_MotionController_2_C__pf2307895703::bpf__UserConstructionScript__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__GetActorNearHand__pf(/*out*/ AActor*& bpp__NearestMesh__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__ReleaseActor__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__GrabActor__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__ActivateTeleporter__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__DisableTeleporter__pf()
{
	int32 CurrentState = 1;
	do
	{
...
void ABP_MotionController_2_C__pf2307895703::bpf__TraceTeleportDestination__pf(/*out*/ bool& bpp__Success__pf, /*out*/ TArray<FVector>& bpp__TracePoints__pf, /*out*/ FVector& bpp__NavMeshLocation__pf, /*out*/ FVector& bpp__TraceLocation__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__ClearArc__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__UpdateArcSpline__pf(bool bpp__FoundValidLocation__pf, /*out*/ TArray<FVector>& bpp__SplinePoints__pf)
{
	int32 bpv__CallFunc_Array_Length_ReturnValue__pf{};
		...
		case 15:
			{
				...
				bpv__CallFunc_AddComponent_ReturnValue__pf = CastChecked<USplineMeshComponent>(AActor::AddComponent(FName(TEXT("NODE_AddSplineMeshComponent-2")), true, bpv__CallFunc_MakeTransform_ReturnValue__pf, this), ECastCheckedType::NullAllowed);
			}
		case 16:
			{
...
void ABP_MotionController_2_C__pf2307895703::bpf__UpdateArcEndpoint__pf(FVector bpp__NewLocation__pf, bool bpp__ValidLocationFound__pf)
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__SetupRoomScaleOutline__pf()
{
	FVector bpv__CallFunc_MakeVector_ReturnValue__pf(EForceInit::ForceInit);
...
void ABP_MotionController_2_C__pf2307895703::bpf__UpdateRoomScaleOutline__pf()
{
	FRotator bpv__CallFunc_GetOrientationAndPosition_DeviceRotation__pf(EForceInit::ForceInit);
	FVector bpv__CallFunc_GetOrientationAndPosition_DevicePosition__pf(EForceInit::ForceInit);
...
void ABP_MotionController_2_C__pf2307895703::bpf__GetTeleportDestination__pf(/*out*/ FVector& bpp__Location__pf, /*out*/ FRotator& bpp__Rotation__pf)
{
	FRotator bpv__CallFunc_GetOrientationAndPosition_DeviceRotation__pf(EForceInit::ForceInit);
	FVector bpv__CallFunc_GetOrientationAndPosition_DevicePosition__pf(EForceInit::ForceInit);
	float bpv__CallFunc_BreakVector_X__pf{};
...
void ABP_MotionController_2_C__pf2307895703::bpf__GrabComponent__pf()
{
...
void ABP_MotionController_2_C__pf2307895703::bpf__GetComponentNearHand__pf(/*out*/ UPrimitiveComponent*& bpp__NearestComponent__pf)
{
	int32 bpv__Temp_int_Array_Index_Variable__pf{};
	int32 bpv__Temp_int_Loop_Counter_Variable__pf{};
	int32 bpv__CallFunc_Add_IntInt_ReturnValue__pf{};
...
void ABP_MotionController_2_C__pf2307895703::bpf__ReleaseComponent__pf()
{
	bool bpv__CallFunc_IsValid_ReturnValue__pf{};
	AActor* bpv__CallFunc_GetOwner_ReturnValue__pf{};
	TScriptInterface<IPickupActorInterface_C> bpv__K2Node_DynamicCast_AsPickup_Actor_Interface__pf{};
		...
		case 3:
			{
				...
				bpv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(bpv__CallFunc_K2_GetRootComponent_ReturnValue__pf, bpv__MotionController__pf);
				if (!bpv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf)
				{
					CurrentState = 4;
					break;
...
void ABP_MotionController_2_C__pf2307895703::__StaticDependencies_CommonAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const TCHAR* __Local__11 = TEXT("/Game/ProtoVRHand/Meshes/Villain");
	const TCHAR* __Local__12 = TEXT("/Engine/BasicShapes");
	const TCHAR* __Local__13 = TEXT("/Game/VirtualReality/Materials");
	const TCHAR* __Local__14 = TEXT("/Game/VirtualReality/Meshes");
	FBlueprintDependencyData LocAssets[] =
	{
		FBlueprintDependencyData(__Local__11, TEXT("Skel_Hand"), TEXT("Skel_Hand"), TEXT("/Script/Engine"), TEXT("SkeletalMesh")),
		FBlueprintDependencyData(__Local__12, TEXT("Sphere"), TEXT("Sphere"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__13, TEXT("M_ArcEndpoint"), TEXT("M_ArcEndpoint"), TEXT("/Script/Engine"), TEXT("Material")),
		FBlueprintDependencyData(__Local__12, TEXT("Cylinder"), TEXT("Cylinder"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__13, TEXT("MI_TeleportCylinderPreview"), TEXT("MI_TeleportCylinderPreview"), TEXT("/Script/Engine"), TEXT("MaterialInstanceConstant")),
		FBlueprintDependencyData(__Local__14, TEXT("SM_FatCylinder"), TEXT("SM_FatCylinder"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__14, TEXT("BeaconDirection"), TEXT("BeaconDirection"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__14, TEXT("1x1_cube"), TEXT("1x1_cube"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__13, TEXT("MI_ChaperoneOutline"), TEXT("MI_ChaperoneOutline"), TEXT("/Script/Engine"), TEXT("MaterialInstanceConstant")),
		FBlueprintDependencyData(__Local__14, TEXT("BeamMesh"), TEXT("BeamMesh"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(__Local__13, TEXT("M_SplineArcMat"), TEXT("M_SplineArcMat"), TEXT("/Script/Engine"), TEXT("Material")),
	};
	for(auto& LocAsset : LocAssets) { AssetsToLoad.Add(LocAsset); } 
}
void ABP_MotionController_2_C__pf2307895703::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
}
void ABP_MotionController_2_C__pf2307895703::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
	...
	const TCHAR* __Local__19 = TEXT("/Game/VirtualRealityBP/Blueprints");
	const TCHAR* __Local__20 = TEXT("/Game/ProtoVRHand/Blueprints/Example");
	FBlueprintDependencyData LocAssets[] =
	{
		...
		FBlueprintDependencyData(__Local__19, TEXT("PickupActorInterface"), TEXT("PickupActorInterface_C"), TEXT("/Script/CoreUObject"), TEXT("DynamicClass")),
		FBlueprintDependencyData(__Local__20, TEXT("Enum_Grip"), TEXT("Enum_Grip"), TEXT("/Script/CoreUObject"), TEXT("Enum")),
	};
	for(auto& LocAsset : LocAssets) { AssetsToLoad.Add(LocAsset); } 
}
struct FRegisterHelper__ABP_MotionController_2_C__pf2307895703
{
	FRegisterHelper__ABP_MotionController_2_C__pf2307895703()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_MotionController_2"), &ABP_MotionController_2_C__pf2307895703::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_MotionController_2_C__pf2307895703 Instance;
};
FRegisterHelper__ABP_MotionController_2_C__pf2307895703 FRegisterHelper__ABP_MotionController_2_C__pf2307895703::Instance;
#ifdef _MSC_VER
#pragma warning (pop)
#endif
