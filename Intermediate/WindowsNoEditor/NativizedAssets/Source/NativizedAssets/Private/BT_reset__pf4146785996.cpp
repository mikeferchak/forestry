...
ABT_reset_C__pf4146785996::ABT_reset_C__pf4146785996(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABT_reset_C__pf4146785996::StaticClass() == GetClass()))
	{
		ABT_reset_C__pf4146785996::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__buttonStaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__buttonStaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__buttonStaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABT_reset_C__pf4146785996::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	...
	TEXT("DO NOT PRESS"), /* Literal Text */
	TEXT("[91F5B1554A0A4520A89C309C61A981DD]"), /* Namespace */
	TEXT("97290D61485AC4E67A5F59A17A4B5559") /* Key */
	);
	bpv__buttonTextRender__pf->WorldSize = 3.000000f;
	bpv__buttonTextRender__pf->bVisible = true;
	bpv__buttonTextRender__pf->RelativeLocation = FVector(1.000000, 0.000000, 3.700000);
	if(!bpv__buttonTextRender__pf->IsTemplate())
	{
		bpv__buttonTextRender__pf->BodyInstance.FixupData(bpv__buttonTextRender__pf);
	}
	bpv__fadeoutDelay__pf = 0.500000f;
	bpv__buttonReleasedMaterial__pf = CastChecked<UMaterialInstance>(CastChecked<UDynamicClass>(ABT_reset_C__pf4146785996::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__buttonPressedMaterial__pf = CastChecked<UMaterialInstance>(CastChecked<UDynamicClass>(ABT_reset_C__pf4146785996::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
}
void ABT_reset_C__pf4146785996::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ABT_reset_C__pf4146785996::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABT_reset_C__pf4146785996::bpf__ExecuteUbergraph_BT_reset__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				UKismetSystemLibrary::Delay(this, bpv__fadeoutDelay__pf, FLatentActionInfo(1, 565660210, TEXT("ExecuteUbergraph_BT_reset_0"), this));
				__CurrentState = -1;
				break;
			}
		case 5:
		...
		case 6:
			{
				Super::bpf__buttonPressed__pf(((AActor*)nullptr));
			}
		case 7:
			{
				...
				{
					bpfv__CallFunc_GetPlayerCameraManager_ReturnValue__pf->StartCameraFade(0.000000, 1.000000, bpv__fadeoutDelay__pf, FLinearColor(0.000000,0.000000,0.000000,1.000000), true, true);
				}
				__CurrentState = 4;
				break;
			}
...
void ABT_reset_C__pf4146785996::bpf__buttonPressed__pf(AActor* bpp__controller__pf)
{
	b1l__K2Node_Event_controller__pf = bpp__controller__pf;
	bpf__ExecuteUbergraph_BT_reset__pf_0(5);
}
void ABT_reset_C__pf4146785996::bpf__UserConstructionScript__pf()
{
	Super::bpf__UserConstructionScript__pf();
}
void ABT_reset_C__pf4146785996::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void ABT_reset_C__pf4146785996::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{46, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/buttons/BT_master.BT_master_C 
...
struct FRegisterHelper__ABT_reset_C__pf4146785996
{
	FRegisterHelper__ABT_reset_C__pf4146785996()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/buttons/BT_reset"), &ABT_reset_C__pf4146785996::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABT_reset_C__pf4146785996 Instance;
};
FRegisterHelper__ABT_reset_C__pf4146785996 FRegisterHelper__ABT_reset_C__pf4146785996::Instance;
