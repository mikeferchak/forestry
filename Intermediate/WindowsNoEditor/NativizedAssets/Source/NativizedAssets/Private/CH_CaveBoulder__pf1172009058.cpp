...
#include "CH_CaveBoulder__pf1172009058.h"
...
ACH_CaveBoulder_C__pf1172009058::ACH_CaveBoulder_C__pf1172009058(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ACH_CaveBoulder_C__pf1172009058::StaticClass() == GetClass()))
	{
		ACH_CaveBoulder_C__pf1172009058::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__mesh__pf = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACH_CaveBoulder_C__pf1172009058::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__startFrozen__pf = true;
	bpv__capOption__pf = EProcMeshSliceCapOption::UseLastSectionForCap;
}
void ACH_CaveBoulder_C__pf1172009058::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ACH_CaveBoulder_C__pf1172009058::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ACH_CaveBoulder_C__pf1172009058::bpf__UserConstructionScript__pf()
{
	Super::bpf__UserConstructionScript__pf();
}
void ACH_CaveBoulder_C__pf1172009058::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{91, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/props/boulder/SM_boulder.SM_boulder 
	};
...
void ACH_CaveBoulder_C__pf1172009058::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ACH_CaveBoulder_C__pf1172009058
{
	FRegisterHelper__ACH_CaveBoulder_C__pf1172009058()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/choppableItems/CH_CaveBoulder"), &ACH_CaveBoulder_C__pf1172009058::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACH_CaveBoulder_C__pf1172009058 Instance;
};
FRegisterHelper__ACH_CaveBoulder_C__pf1172009058 FRegisterHelper__ACH_CaveBoulder_C__pf1172009058::Instance;
