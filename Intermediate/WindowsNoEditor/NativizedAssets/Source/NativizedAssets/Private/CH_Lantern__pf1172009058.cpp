...
#include "CH_Lantern__pf1172009058.h"
...
ACH_Lantern_C__pf1172009058::ACH_Lantern_C__pf1172009058(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ACH_Lantern_C__pf1172009058::StaticClass() == GetClass()))
	{
		ACH_Lantern_C__pf1172009058::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__staticmeshref__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACH_Lantern_C__pf1172009058::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	if(!bpv__staticmeshref__pf->IsTemplate())
	{
		bpv__staticmeshref__pf->BodyInstance.FixupData(bpv__staticmeshref__pf);
	}
	bpv__mesh__pf = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACH_Lantern_C__pf1172009058::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__createCollision__pf = true;
	bpv__hitMass__pf = (E__choppableHitMass__pf)(5);
}
void ACH_Lantern_C__pf1172009058::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ACH_Lantern_C__pf1172009058::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ACH_Lantern_C__pf1172009058::bpf__UserConstructionScript__pf()
{
	Super::bpf__UserConstructionScript__pf();
}
void ACH_Lantern_C__pf1172009058::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{72, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/props/lantern/SM_lantern.SM_lantern 
	};
...
void ACH_Lantern_C__pf1172009058::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ACH_Lantern_C__pf1172009058
{
	FRegisterHelper__ACH_Lantern_C__pf1172009058()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/choppableItems/CH_Lantern"), &ACH_Lantern_C__pf1172009058::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACH_Lantern_C__pf1172009058 Instance;
};
FRegisterHelper__ACH_Lantern_C__pf1172009058 FRegisterHelper__ACH_Lantern_C__pf1172009058::Instance;
