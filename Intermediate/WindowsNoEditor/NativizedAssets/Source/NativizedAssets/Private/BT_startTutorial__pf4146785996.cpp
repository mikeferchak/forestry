...
#include "BT_startTutorial__pf4146785996.h"
...
ABT_startTutorial_C__pf4146785996::ABT_startTutorial_C__pf4146785996(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABT_startTutorial_C__pf4146785996::StaticClass() == GetClass()))
	{
		ABT_startTutorial_C__pf4146785996::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__buttonTextRender__pf->Text = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("START TUTORIAL"), /* Literal Text */
	TEXT("[3A7D38004E12CBD29D2FFEA8217BC5B3]"), /* Namespace */
	TEXT("C4D6D3EC4C37B77D606CE8860E18C52E") /* Key */
	);
	bpv__buttonTextRender__pf->TextRenderColor = FColor(0, 0, 0, 255);
	bpv__buttonTextRender__pf->YScale = 1.339313f;
	bpv__buttonTextRender__pf->WorldSize = 2.504750f;
...
void ABT_startTutorial_C__pf4146785996::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ABT_startTutorial_C__pf4146785996::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABT_startTutorial_C__pf4146785996::bpf__ExecuteUbergraph_BT_startTutorial__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b1l__K2Node_DynamicCast_AsLog_Pawn__pf = NoNativeCast<APawn>(CastChecked<UClass>(CastChecked<UDynamicClass>(ABT_startTutorial_C__pf4146785996::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), bpfv__CallFunc_GetPlayerPawn_ReturnValue__pf);
	...
	{
		FUnconvertedWrapper__Alog_pawn_C__pf2672032748(b1l__K2Node_DynamicCast_AsLog_Pawn__pf).bpf__buttonStartTutorial__pf();
	}
	return; // KCST_GotoReturn
}
void ABT_startTutorial_C__pf4146785996::bpf__buttonPressed__pf(AActor* bpp__controller__pf)
{
	b1l__K2Node_Event_controller__pf = bpp__controller__pf;
	bpf__ExecuteUbergraph_BT_startTutorial__pf_0(3);
}
void ABT_startTutorial_C__pf4146785996::bpf__UserConstructionScript__pf()
{
	Super::bpf__UserConstructionScript__pf();
}
void ABT_startTutorial_C__pf4146785996::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void ABT_startTutorial_C__pf4146785996::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
struct FRegisterHelper__ABT_startTutorial_C__pf4146785996
{
	FRegisterHelper__ABT_startTutorial_C__pf4146785996()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/buttons/BT_startTutorial"), &ABT_startTutorial_C__pf4146785996::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABT_startTutorial_C__pf4146785996 Instance;
};
FRegisterHelper__ABT_startTutorial_C__pf4146785996 FRegisterHelper__ABT_startTutorial_C__pf4146785996::Instance;
