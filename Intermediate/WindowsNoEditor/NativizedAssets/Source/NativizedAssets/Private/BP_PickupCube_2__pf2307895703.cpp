...
#include "BP_PickupCube_2__pf2307895703.h"
...
#endif
ABP_PickupCube_2_C__pf2307895703::ABP_PickupCube_2_C__pf2307895703(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABP_PickupCube_2_C__pf2307895703::StaticClass() == GetClass()))
	{
		ABP_PickupCube_2_C__pf2307895703::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	auto __Local__0 = CastChecked<UStaticMeshComponent>(GetDefaultSubobjectByName(TEXT("StaticMeshComponent0")));
	__Local__0->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_PickupCube_2_C__pf2307895703::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_PickupCube_2_C__pf2307895703::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void ABP_PickupCube_2_C__pf2307895703::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
void ABP_PickupCube_2_C__pf2307895703::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
void ABP_PickupCube_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_PickupCube_2__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABP_PickupCube_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_PickupCube_2__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_PickupCube_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_PickupCube_2__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	return; // KCST_GotoReturn
}
void ABP_PickupCube_2_C__pf2307895703::bpf__ExecuteUbergraph_BP_PickupCube_2__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	return; // KCST_GotoReturn
}
void ABP_PickupCube_2_C__pf2307895703::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_BP_PickupCube_2__pf_0(3);
}
void ABP_PickupCube_2_C__pf2307895703::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_BP_PickupCube_2__pf_1(6);
}
void ABP_PickupCube_2_C__pf2307895703::bpf__DropComponent__pf(UPrimitiveComponent* bpp__component__pf)
{
	b0l__K2Node_Event_component__pf = bpp__component__pf;
	bpf__ExecuteUbergraph_BP_PickupCube_2__pf_2(7);
}
void ABP_PickupCube_2_C__pf2307895703::bpf__PickupComponent__pf(USceneComponent* bpp__AttachTo__pf, UPrimitiveComponent* bpp__Component__pf)
{
	b0l__K2Node_Event_AttachTo2__pf = bpp__AttachTo__pf;
	b0l__K2Node_Event_Component2__pf = bpp__Component__pf;
	bpf__ExecuteUbergraph_BP_PickupCube_2__pf_3(8);
}
void ABP_PickupCube_2_C__pf2307895703::bpf__UserConstructionScript__pf()
{
}
void ABP_PickupCube_2_C__pf2307895703::__StaticDependencies_CommonAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
void ABP_PickupCube_2_C__pf2307895703::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
}
void ABP_PickupCube_2_C__pf2307895703::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
...
struct FRegisterHelper__ABP_PickupCube_2_C__pf2307895703
{
	FRegisterHelper__ABP_PickupCube_2_C__pf2307895703()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_PickupCube_2"), &ABP_PickupCube_2_C__pf2307895703::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_PickupCube_2_C__pf2307895703 Instance;
};
FRegisterHelper__ABP_PickupCube_2_C__pf2307895703 FRegisterHelper__ABP_PickupCube_2_C__pf2307895703::Instance;
#ifdef _MSC_VER
#pragma warning (pop)
#endif
